...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE OR REPLACE VIEW `view_unallocated_material_request_items` AS
                SELECT
                ...
                LEFT JOIN request_container_allocations rcl
    ...
    {
        DB::unprepared("DROP VIEW IF EXISTS view_unallocated_material_request_items");
    }
};
